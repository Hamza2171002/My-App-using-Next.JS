...
const About = () => {
    return (
        <div>
            <div>
                <Navbar />
                <h1 className='text-2xl items-center font-bold mt-20 text-center bg-green-700 text-white'>Components:</h1>
                ...
                <h1 className='text-2xl font-bold mt-20 text-center bg-green-700 text-white'>Linking:</h1>
                ...
                <h1 className='text-2xl font-bold mt-20 text-center bg-green-700 text-white'>Rounting</h1>
            ...
            <p className='text-center mt-14 bg-blue-100'>&copy;Muhammad Hamza</p>
        </div>
    )
}
